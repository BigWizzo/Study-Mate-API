...
class ClockingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clocking" do
    assert_difference('Clocking.count') do
      post clockings_url, params: { clocking: { details: @clocking.details, duration: @clocking.duration, topic: @clocking.topic } }, as: :json
    end
  ...
  test "should update clocking" do
    patch clocking_url(@clocking), params: { clocking: { details: @clocking.details, duration: @clocking.duration, topic: @clocking.topic } }, as: :json
    assert_response 200
  end
